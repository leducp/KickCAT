...
namespace kickcat
{
    namespace pdo
    {
        ...
        constexpr uint32_t tx_mapping[] = {0x60410010, 0x60640020}; // uint32_t is 0x[Address(4byte), SubIndex(2byte), typeSizeInBits(2byte)]
        ...
        constexpr uint32_t rx_mapping[] = {0x60400010, 0x60600010, 0x607A0020}; // uint32_t is 0x[Address(4byte), SubIndex(2byte), typeSizeInBits(2byte)]
