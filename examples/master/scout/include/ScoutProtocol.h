...
namespace kickcat
{
    namespace pdo
    {
        ...
        constexpr uint32_t tx_mapping[] = {0x60640020, 0x606C0020, 0x60770010, 0x60f40020, 0x60fc0020, 0x60410010}; // uint32_t is 0x[Address(4byte), SubIndex(2byte), typeSizeInBits(2byte)]
        ...
        constexpr uint32_t rx_mapping[] = {0x607A0020, 0x60FF0020, 0x60710010, 0x60B10020, 0x60400010, 0x60600010}; // uint32_t is 0x[Address(4byte), SubIndex(2byte), typeSizeInBits(2byte)]
