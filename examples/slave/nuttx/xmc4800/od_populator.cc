...
namespace kickcat::CoE
{
    CoE::Dictionary createOD()
    {
...

        {
            ...
            CoE::addEntry<uint8_t>(object,0,8,0,15,static_cast<CoE::DataType>(5),"Subindex 000",0x1);
            CoE::addEntry<uint32_t>(object,1,32,16,15,static_cast<CoE::DataType>(7),"RxPDO assign Element 1",0x1600);
            dictionary.push_back(std::move(object));
        }

        {
            ...
            CoE::addEntry<uint8_t>(object,0,8,0,15,static_cast<CoE::DataType>(5),"Subindex 000",0x1);
            CoE::addEntry<uint32_t>(object,1,32,16,15,static_cast<CoE::DataType>(7),"TxPDO assign Element 1",0x1a00);
            dictionary.push_back(std::move(object));
        }
