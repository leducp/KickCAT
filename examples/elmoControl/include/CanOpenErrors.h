...
namespace can
{
    namespace emergency
    {
        ...
        namespace errorRegister
        {
            ...
            {
                if ((reg & errorRegister::GENERIC_ERROR) == errorRegister::GENERIC_ERROR) {return "GENERIC_ERROR\n";}
                else if ((reg & errorRegister::CURRENT) == errorRegister::CURRENT) {return "CURRENT\n";}
                else if ((reg & errorRegister::VOLTAGE) == errorRegister::VOLTAGE) {return "VOLTAGE\n";}
                else if ((reg & errorRegister::TEMPERATURE) == errorRegister::TEMPERATURE) {return "TEMPERATURE\n";}
                else if ((reg & errorRegister::COMMUNICATION_ERROR) == errorRegister::COMMUNICATION_ERROR) {return "COMMUNICATION_ERROR\n";}
                else if ((reg & errorRegister::DEVICE_SPECIFIC) == errorRegister::DEVICE_SPECIFIC) {return "DEVICE_SPECIFIC\n";}
                else if ((reg & errorRegister::MANUFACTURER_SPECIFIC) == errorRegister::MANUFACTURER_SPECIFIC) {return "MANUFACTURER_SPECIFIC\n";}
                else {return "UNKOWN\n";}
            }
        }
